...
class PendingScheduleView extends StatefulWidget {
  ...
  const PendingScheduleView({super.key, required this.dynamicDays});

  @override
  State<PendingScheduleView> createState() => _PendingScheduleViewState();
}
      ...
      builder: (context, ref, _) {
        ...
        return CustomScrollView(
          slivers: [
            ...
            SliverToBoxAdapter(
              child: DaySelector(
                itemCount: widget.dynamicDays.length + 1, // +1 for '여행 전체'
                        ...
                        (buttonContext) => TextButton(
                          onPressed: () {
                            ...
                            GoRouter.of(buttonContext).push(
                              '/naverPlaceMapScreen?day=${daySchedule.day}',
                            );
                          },
